...
import type { EditorialItem, EditorialKind } from "@/admin/editorial/model";
import { Empty, ErrorNote, LoadingRows, PageHeader } from "@/admin/components/primitives";
...
import type { EditorialStatus, Note, Project } from "@/types";
