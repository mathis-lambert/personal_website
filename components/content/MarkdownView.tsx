...
import { codeTheme } from "@/lib/ui/codeTheme";
...
/** A fenced code block: language label, copy button, restrained syntax theme. */
function CodeBlock({ code, language }: { code: string; language: string }) {
  ...
  return (
    <div className="editorial-code-block my-7 overflow-hidden rounded-4 bg-[#17191d]">
