...
const GlassCard: React.FC<GlassCardProps> = ({
  ...
  return (
    ...
    >
      <div
        className={cn(
          `flex h-full rounded-3xl backdrop-blur-2xl border-1 border-white color relative shadow-lg overflow-hidden transition-all duration-300 ease-in-out hover:scale-102 dark:bg-gray-800/5 dark:text-white dark:border-white/20`,
        )}
        style={dynamicStyles}
      >
        {title && (
