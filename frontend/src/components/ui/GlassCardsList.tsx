...
const GlassCardsList = () => {
  return (
    <div className="grid xs:grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 lg:grid-rows-[repeat(3,300px)] sm:grid-rows-[repeat(3,250px)] grid-rows-[repeat(3,200px)] gap-4 sm:gap-6 lg:gap-12">
      <GlassCard title="Assistant IA">
        <p>
