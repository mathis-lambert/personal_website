  ...
  return (
    <motion.a
      ...
      className={cn(
        ...
        `bg-gray-400/10 border-white/30 text-gray-800 hover:bg-white/30 hover:border-white/40 hover:shadow-lg hover:scale-[1.03]`,
        `dark:bg-gray-800/30 dark:border-white/10 dark:text-gray-200 dark:hover:bg-gray-700/50 dark:hover:border-white/20 dark:hover:shadow-xl`,
        className,
      )}
