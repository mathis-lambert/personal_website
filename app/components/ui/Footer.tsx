      ...
      <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 border-t border-gray-200 pt-6 dark:border-gray-500">
          ...
          <div className="mt-4 text-xs text-center text-gray-500">
            <Link
              href="/admin"
              className="bg-blue-100 hover:bg-blue-200 transition duration-200 rounded px-2 py-1 dark:bg-blue-800 dark:hover:bg-blue-700 text-blue-600 dark:text-blue-400"
            >
              Administration
            </Link>
          </div>
